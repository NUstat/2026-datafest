...
::: {.profile-photo .right}
![](images/david.jpg){alt="David Gormley"}
:::
...
::: {.profile-photo .left}
![](images/sutter.jpg){alt="Sutter Augur"}
:::
...
Sutter's interests lie in machine learning, regression analysis, and statistical inference.
...
He is an incoming Data Science Intern at Strata Decision Technologies.
